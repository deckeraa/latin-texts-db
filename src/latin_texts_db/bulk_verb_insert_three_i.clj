(ns latin-texts-db.bulk-verb-insert-three-i
  (:require
   [latin-texts-db.db :refer [ll]]))

;; not i-stems that will be in a different file
(defn get-verb-forms-ere-i [first-person-present infinitive first-person-perfect supine first-person-present-sg-gloss third-person-present-sg-gloss first-person-perfect-sg-gloss present-participle]
  (let [present-stem (subs first-person-present 0 (- (count first-person-present) 2))
    ...
    [
     ...
     {:wordform (str present-stem "eris") :gloss (str "you are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "present" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "itur") :gloss (str "he/she/it is " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "singular" :tense "present" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "imur") :gloss (str "we are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "plural" :tense "present" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "iminī") :gloss (str "you are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "plural" :tense "present" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     ...
     {:wordform  (str present-stem "ī") :gloss (str "to be " first-person-perfect-sg-gloss) :part_of_speech "verb" :tense "present" :voice "passive" :mood "infinitive" :lexeme_id (ll df)}
     ...
     {:wordform  (str present-stem "ere") :gloss (str "be "first-person-perfect-sg-gloss "!") :part_of_speech "verb" :tense "present" :voice "passive" :number "singular" :mood "imperative" :lexeme_id (ll df)}
     {:wordform  (str present-stem "iminī") :gloss (str "be "first-person-perfect-sg-gloss "!") :part_of_speech "verb" :tense "present" :voice "passive" :number "plural" :mood "imperative" :lexeme_id (ll df)}
