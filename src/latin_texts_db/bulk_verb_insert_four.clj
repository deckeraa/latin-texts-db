(ns latin-texts-db.bulk-verb-insert-four
  (:require
   [latin-texts-db.db :refer [ll]]))

(defn get-verb-forms-īre [first-person-present infinitive first-person-perfect supine first-person-present-sg-gloss third-person-present-sg-gloss first-person-perfect-sg-gloss present-participle]
  (let [present-stem (subs first-person-present 0 (- (count first-person-present) 2))
    ...
    [
     ...
     {:wordform (str perfect-stem-minus-v "eram") :gloss (str "I had " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "singular" :tense "pluperfect" :voice "active" :mood "indicative" :lexeme_id (ll df)}
     ...
     {:wordform (str perfect-stem-minus-v "erās") :gloss (str "you had " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "pluperfect" :voice "active" :mood "indicative" :lexeme_id (ll df)}
     ...
     {:wordform (str perfect-stem-minus-v "erat") :gloss (str "he/she/it had " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "singular" :tense "pluperfect" :voice "active" :mood "indicative" :lexeme_id (ll df)}
     ...
     {:wordform (str perfect-stem-minus-v "erāmus") :gloss (str "we had " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "plural" :tense "pluperfect" :voice "active" :mood "indicative" :lexeme_id (ll df)}
     ...
     {:wordform (str perfect-stem-minus-v "erātis") :gloss (str "you had " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "plural" :tense "pluperfect" :voice "active" :mood "indicative" :lexeme_id (ll df)}
     ...
     {:wordform (str perfect-stem-minus-v "erant") :gloss (str "they had " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "plural" :tense "pluperfect" :voice "active" :mood "indicative" :lexeme_id (ll df)}
     ...
     {:wordform (str perfect-stem-minus-v "erō") :gloss (str "I will have " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "singular" :tense "future-perfect" :voice "active" :mood "indicative" :lexeme_id (ll df)}
     ...
     {:wordform (str perfect-stem-minus-v "eris") :gloss (str "you will have " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "future-perfect" :voice "active" :mood "indicative" :lexeme_id (ll df)}
     ...
     {:wordform (str perfect-stem-minus-v "erit") :gloss (str "he/she/it will have " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "singular" :tense "future-perfect" :voice "active" :mood "indicative" :lexeme_id (ll df)}
     ...
     {:wordform (str perfect-stem-minus-v "erimus") :gloss (str "we will have " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "plural" :tense "future-perfect" :voice "active" :mood "indicative" :lexeme_id (ll df)}
     ...
     {:wordform (str perfect-stem-minus-v "eritis") :gloss (str "you will have " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "plural" :tense "future-perfect" :voice "active" :mood "indicative" :lexeme_id (ll df)}
     ...
     {:wordform (str perfect-stem-minus-v "erint") :gloss (str "they will have " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "plural" :tense "future-perfect" :voice "active" :mood "indicative" :lexeme_id (ll df)}
     ...
     {:wordform (str perfect-stem "issem") :gloss (str "I had " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "singular" :tense "pluperfect" :voice "active" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str perfect-stem-minus-v "ssem") :gloss (str "I had " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "singular" :tense "pluperfect" :voice "active" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str perfect-stem "issēs") :gloss (str "you had " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "pluperfect" :voice "active" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str perfect-stem-minus-v "ssēs") :gloss (str "you had " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "pluperfect" :voice "active" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str perfect-stem "isset") :gloss (str "he/she/it had " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "singular" :tense "pluperfect" :voice "active" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str perfect-stem-minus-v "sset") :gloss (str "he/she/it had " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "singular" :tense "pluperfect" :voice "active" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str perfect-stem "issēmus") :gloss (str "we had " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "plural" :tense "pluperfect" :voice "active" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str perfect-stem-minus-v "ssēmus") :gloss (str "we had " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "plural" :tense "pluperfect" :voice "active" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str perfect-stem "issētis") :gloss (str "you had " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "plural" :tense "pluperfect" :voice "active" :mood "subjunctive" :lexeme_id (ll df)}
     ...
     {:wordform (str present-stem "ior") :gloss (str "I am " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "singular" :tense "present" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "īris") :gloss (str "you are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "present" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "ītur") :gloss (str "he/she/it is " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "singular" :tense "present" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "īmur") :gloss (str "we are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "plural" :tense "present" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "īminī") :gloss (str "you are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "plural" :tense "present" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "iuntur") :gloss (str "they are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "plural" :tense "present" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     ;; skipping perfect passive indicative since those require two words like 'pulsātus sum'
     ;; future passive indicative
     {:wordform (str present-stem "iar") :gloss (str "I will be " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "singular" :tense "future" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "iēris") :gloss (str "you will be " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "future" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "iēre") :gloss (str "you will be " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "future" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "iētur") :gloss (str "he/she/it will be " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "singular" :tense "future" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "iēmur") :gloss (str "we will be " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "plural" :tense "future" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "iēminī") :gloss (str "you will be " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "plural" :tense "future" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "ientur") :gloss (str "they will be " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "plural" :tense "future" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     ;; imperfect passive indicative
     {:wordform (str present-stem "iēbar") :gloss (str "I was being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "singular" :tense "imperfect" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "iēbāris") :gloss (str "you were being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "imperfect" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "iēbāre") :gloss (str "you were being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "imperfect" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "iēbātur") :gloss (str "he/she/it was being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "singular" :tense "imperfect" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "iēbāmur") :gloss (str "we were being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "plural" :tense "imperfect" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "iēbāminī") :gloss (str "you were being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "plural" :tense "imperfect" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "iēbantur") :gloss (str "they were being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "plural" :tense "imperfect" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     ;; skipping pluperfect passive indicative and future-perfect passive indicative because they require helper words
     ;; present passive subjunctive
     {:wordform (str present-stem "iar") :gloss (str "I am " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "singular" :tense "present" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str present-stem "iāris") :gloss (str "you are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "present" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str present-stem "iāre") :gloss (str "you are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "present" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str present-stem "iātur") :gloss (str "he/she/it is " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "singular" :tense "present" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str present-stem "iāmur") :gloss (str "we are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "plural" :tense "present" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str present-stem "iāminī") :gloss (str "you are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "plural" :tense "present" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str present-stem "iantur") :gloss (str "they are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "plural" :tense "present" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     ;; imperfect passive subjunctive 
     {:wordform (str infinitive-stem "er") :gloss (str "I was being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "singular" :tense "imperfect" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str infinitive-stem "ēris") :gloss (str "you were being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "imperfect" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str infinitive-stem "ēre") :gloss (str "you were being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "imperfect" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     ...
     {:wordform (str infinitive-stem "ēmur") :gloss (str "we were being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "plural" :tense "imperfect" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str infinitive-stem "ēminī") :gloss (str "you were being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "plural" :tense "imperfect" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str infinitive-stem "entur") :gloss (str "they were being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "plural" :tense "imperfect" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     ;; infinitives
     ...
     {:wordform  (str present-stem "īrī") :gloss (str "to be " first-person-perfect-sg-gloss) :part_of_speech "verb" :tense "present" :voice "passive" :mood "infinitive" :lexeme_id (ll df)}
     ...
     {:wordform  (str present-stem "īre") :gloss (str "be "first-person-perfect-sg-gloss "!") :part_of_speech "verb" :tense "present" :voice "passive" :number "singular" :mood "imperative" :lexeme_id (ll df)}
     {:wordform  (str present-stem "īminī") :gloss (str "be "first-person-perfect-sg-gloss "!") :part_of_speech "verb" :tense "present" :voice "passive" :number "plural" :mood "imperative" :lexeme_id (ll df)}
     ...
     {:wordform (str participial-stem "a") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "feminine" :number "singular" :case_ "nominative" :lexeme_id (ll df)}
     {:wordform (str participial-stem "ae") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "feminine" :number "singular" :case_ "genitive" :lexeme_id (ll df)}
     {:wordform (str participial-stem "ae") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "feminine" :number "singular" :case_ "dative" :lexeme_id (ll df)}
     {:wordform (str participial-stem "am") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "feminine" :number "singular" :case_ "accusative" :lexeme_id (ll df)}
     {:wordform (str participial-stem "ā") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "feminine" :number "singular" :case_ "ablative" :lexeme_id (ll df)}
     {:wordform (str participial-stem "ae") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "feminine" :number "plural" :case_ "nominative" :lexeme_id (ll df)}
     {:wordform (str participial-stem "ārum") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "feminine" :number "plural" :case_ "genitive" :lexeme_id (ll df)}
     {:wordform (str participial-stem "īs") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "feminine" :number "plural" :case_ "dative" :lexeme_id (ll df)}
     {:wordform (str participial-stem "ās") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "feminine" :number "plural" :case_ "accusative" :lexeme_id (ll df)}
     {:wordform (str participial-stem "īs") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "feminine" :number "plural" :case_ "ablative" :lexeme_id (ll df)}
     ...
     {:wordform (str participial-stem "um") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "neuter" :number "singular" :case_ "nominative" :lexeme_id (ll df)}
     {:wordform (str participial-stem "ī") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "neuter" :number "singular" :case_ "genitive" :lexeme_id (ll df)}
     {:wordform (str participial-stem "ō") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "neuter" :number "singular" :case_ "dative" :lexeme_id (ll df)}
     {:wordform (str participial-stem "um") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "neuter" :number "singular" :case_ "accusative" :lexeme_id (ll df)}
     {:wordform (str participial-stem "ō") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "neuter" :number "singular" :case_ "ablative" :lexeme_id (ll df)}
     {:wordform (str participial-stem "a") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "neuter" :number "plural" :case_ "nominative" :lexeme_id (ll df)}
     {:wordform (str participial-stem "ōrum") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "neuter" :number "plural" :case_ "genitive" :lexeme_id (ll df)}
     {:wordform (str participial-stem "īs") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "neuter" :number "plural" :case_ "dative" :lexeme_id (ll df)}
     {:wordform (str participial-stem "a") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "neuter" :number "plural" :case_ "accusative" :lexeme_id (ll df)}
     {:wordform (str participial-stem "īs") :gloss (str "having been " first-person-perfect-sg-gloss) :part_of_speech "participle" :tense "perfect" :voice "passive" :mood "indicative" :gender "neuter" :number "plural" :case_ "ablative" :lexeme_id (ll df)}
