(ns latin-texts-db.bulk-verb-insert-three
  (:require
   [latin-texts-db.db :refer [ll]]))

;; not i-stems that will be in a different file
(defn get-verb-forms-ere [first-person-present infinitive first-person-perfect supine first-person-present-sg-gloss third-person-present-sg-gloss first-person-perfect-sg-gloss present-participle]
  (let [present-stem (subs first-person-present 0 (dec (count first-person-present)))
    ...
    [
     ...
     {:wordform (str present-stem "untur") :gloss (str "they are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "plural" :tense "present" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     ;; skipping perfect passive indicative since those require two words like 'pulsātus sum'
     ;; future passive indicative
     {:wordform (str present-stem "ar") :gloss (str "I will be " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "singular" :tense "future" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "ēris") :gloss (str "you will be " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "future" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "ēre") :gloss (str "you will be " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "future" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "ētur") :gloss (str "he/she/it will be " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "singular" :tense "future" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "ēmur") :gloss (str "we will be " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "plural" :tense "future" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "ēminī") :gloss (str "you will be " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "plural" :tense "future" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "entur") :gloss (str "they will be " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "plural" :tense "future" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     ;; imperfect passive indicative
     {:wordform (str present-stem "ēbar") :gloss (str "I was being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "singular" :tense "imperfect" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "ēbāris") :gloss (str "you were being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "imperfect" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "ēbāre") :gloss (str "you were being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "imperfect" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "ēbātur") :gloss (str "he/she/it was being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "singular" :tense "imperfect" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "ēbāmur") :gloss (str "we were being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "plural" :tense "imperfect" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "ēbāminī") :gloss (str "you were being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "plural" :tense "imperfect" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     {:wordform (str present-stem "ēbantur") :gloss (str "they were being " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "plural" :tense "imperfect" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
     ;; skipping pluperfect passive indicative and future-perfect passive indicative because they require helper words
     ;; present passive subjunctive
     {:wordform (str present-stem "ar") :gloss (str "I am " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "singular" :tense "present" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str present-stem "āris") :gloss (str "you are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "present" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str present-stem "āre") :gloss (str "you are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "present" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str present-stem "ātur") :gloss (str "he/she/it is " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "singular" :tense "present" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str present-stem "āmur") :gloss (str "we are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 1 :number "plural" :tense "present" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str present-stem "āminī") :gloss (str "you are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 2 :number "plural" :tense "present" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
     {:wordform (str present-stem "antur") :gloss (str "they are " first-person-perfect-sg-gloss) :part_of_speech "verb" :person 3 :number "plural" :tense "present" :voice "passive" :mood "subjunctive" :lexeme_id (ll df)}
