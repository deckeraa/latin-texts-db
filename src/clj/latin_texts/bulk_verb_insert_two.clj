(ns latin-texts.bulk-verb-insert-two
  (:require
...
(defn present-active-indicative [{:keys [first-person-present first-person-present-sg-gloss present-stem third-person-present-sg-gloss df]}]
...
(defn perfect-active-indicative [{:keys [first-person-perfect first-person-perfect-sg-gloss perfect-stem third-person-perfect-sg-gloss df]}]
...
(defn perfect-active-subjunctive [{:keys [perfect-stem first-person-perfect-sg-gloss third-person-perfect-sg-gloss df]}]
...
(defn present-passive-indicative [{:keys [present-stem first-person-perfect-sg-gloss df]}]
...
(defn imperfect-passive-subjunctive [{:keys [infinitive-stem perfect-participle df]}]
...
(defn infinitives [{:keys [infinitive infinitive-stem first-person-present-sg-gloss df perfect-stem perfect-participle]}]
...
(defn get-verb-forms-ēre* [{:keys [first-person-present infinitive first-person-perfect supine first-person-present-sg-gloss third-person-present-sg-gloss first-person-perfect-sg-gloss perfect-participle present-participle skip-participles?] :as args}]
  (let [present-stem (subs first-person-present 0 (- (count first-person-present) 2))
        ...
        args (assoc args :present-stem present-stem :perfect-stem perfect-stem :perfect-stem-minus-v perfect-stem-minus-v :infinitive-stem infinitive-stem :df df :participial-stem participial-stem)]
    (concat
     ...
     (when-not skip-participles?
       (concat
        ...
        (femize (present-active-participles-m args))
...
(defn present-active-indicative-dep [{:keys [first-person-present first-person-present-sg-gloss present-stem third-person-present-sg-gloss df]}]
  [{:wordform first-person-present :gloss (str "I " first-person-present-sg-gloss) :part_of_speech "verb" :person 1 :number "singular" :tense "present" :voice "active" :mood "indicative" :lexeme_id (ll df)}
   {:wordform (str present-stem "ēris") :gloss (str "you " first-person-present-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "present" :voice "active" :mood "indicative" :lexeme_id (ll df)}
   {:wordform (str present-stem "ētur") :gloss (str "he/she/it " third-person-present-sg-gloss) :part_of_speech "verb" :person 3 :number "singular" :tense "present" :voice "active" :mood "indicative" :lexeme_id (ll df)}
   {:wordform (str present-stem "ēmur") :gloss (str "we " first-person-present-sg-gloss) :part_of_speech "verb" :person 1 :number "plural" :tense "present" :voice "active" :mood "indicative" :lexeme_id (ll df)}
   {:wordform (str present-stem "ēminī") :gloss (str "you " first-person-present-sg-gloss) :part_of_speech "verb" :person 2 :number "plural" :tense "present" :voice "active" :mood "indicative" :lexeme_id (ll df)}
   {:wordform (str present-stem "entur") :gloss (str "they " first-person-present-sg-gloss) :part_of_speech "verb" :person 3 :number "plural" :tense "present" :voice "active" :mood "indicative" :lexeme_id (ll df)}])
...
(defn future-active-indicative-dep [{:keys [first-person-present first-person-present-sg-gloss present-stem third-person-present-sg-gloss df]}]
  [{:wordform (str present-stem "ēbor") :gloss (str "I will " first-person-present-sg-gloss) :part_of_speech "verb" :person 1 :number "singular" :tense "future" :voice "active" :mood "indicative" :lexeme_id (ll df)}
   {:wordform (str present-stem "ēberis") :gloss (str "you will " first-person-present-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "future" :voice "active" :mood "indicative" :lexeme_id (ll df)}
   {:wordform (str present-stem "ēbitur") :gloss (str "he/she/it will " third-person-present-sg-gloss) :part_of_speech "verb" :person 3 :number "singular" :tense "future" :voice "active" :mood "indicative" :lexeme_id (ll df)}
   {:wordform (str present-stem "ēbimur") :gloss (str "we will " first-person-present-sg-gloss) :part_of_speech "verb" :person 1 :number "plural" :tense "future" :voice "active" :mood "indicative" :lexeme_id (ll df)}
   {:wordform (str present-stem "ēbiminī") :gloss (str "you will " first-person-present-sg-gloss) :part_of_speech "verb" :person 2 :number "plural" :tense "future" :voice "active" :mood "indicative" :lexeme_id (ll df)}
   {:wordform (str present-stem "ēbuntur") :gloss (str "they will " first-person-present-sg-gloss) :part_of_speech "verb" :person 3 :number "plural" :tense "future" :voice "active" :mood "indicative" :lexeme_id (ll df)}])
...
(defn present-active-subjunctive-dep [{:keys [first-person-present first-person-present-sg-gloss present-stem third-person-present-sg-gloss df]}]
  [{:wordform (str present-stem "ear") :gloss (str "I " first-person-present-sg-gloss) :part_of_speech "verb" :person 1 :number "singular" :tense "present" :voice "active" :mood "subjunctive" :lexeme_id (ll df)}
   {:wordform (str present-stem "eāris") :gloss (str "you " first-person-present-sg-gloss) :part_of_speech "verb" :person 2 :number "singular" :tense "present" :voice "active" :mood "subjunctive" :lexeme_id (ll df)}
   {:wordform (str present-stem "eātur") :gloss (str "he/she/it " third-person-present-sg-gloss) :part_of_speech "verb" :person 3 :number "singular" :tense "present" :voice "active" :mood "subjunctive" :lexeme_id (ll df)}
   {:wordform (str present-stem "eāmur") :gloss (str "we " first-person-present-sg-gloss) :part_of_speech "verb" :person 1 :number "plural" :tense "present" :voice "active" :mood "subjunctive" :lexeme_id (ll df)}
...
(defn imperatives-dep [{:keys [present-stem first-person-present-sg-gloss df perfect-participle]}]
  [{:wordform  (str present-stem "ēre") :gloss (str first-person-present-sg-gloss "!") :part_of_speech "verb" :tense "present" :voice "active" :number "singular" :mood "imperative" :lexeme_id (ll df)}
   {:wordform  (str present-stem "ēminī") :gloss (str first-person-present-sg-gloss "!") :part_of_speech "verb" :tense "present" :voice "active" :number "plural" :mood "imperative" :lexeme_id (ll df)}])
