(ns latin-texts.bulk-verb-insert-three-i
  (:require
...
(defn present-passive-indicative [{:keys [present-stem perfect-participle df]}]
  [{:wordform (str present-stem "ior") :gloss (str "I am " perfect-participle) :part_of_speech "verb" :person 1 :number "singular" :tense "present" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
   {:wordform (str present-stem "eris") :gloss (str "you are " perfect-participle) :part_of_speech "verb" :person 2 :number "singular" :tense "present" :voice "passive" :mood "indicative" :lexeme_id (ll df)}
...
(defn infinitives [{:keys [infinitive first-person-present-sg-gloss perfect-participle df perfect-stem present-stem]}]
...
(defn imperatives [{:keys [present-stem first-person-present-sg-gloss perfect-participle df]}]
...
(defn perfect-passive-participles-m [{:keys [participial-stem perfect-participle df dep? present-participle]}]
  (let [gloss (if dep?
...
(defn get-verb-forms-ere-i* [{:keys [first-person-present infinitive first-person-perfect supine first-person-present-sg-gloss third-person-present-sg-gloss first-person-perfect-sg-gloss perfect-participle present-participle skip-participles?] :as args}]
...
(defn get-verb-forms-ere-i*-dep [{:keys [first-person-present infinitive supine first-person-present-sg-gloss third-person-present-sg-gloss first-person-perfect-sg-gloss present-participle] :as args}]
