...
(defn get-adjective-forms [{:keys [mf n sup-m pos-gloss comp-gloss sup-gloss pl-gen-ium? include-comparative? include-superlative?] :as args}]
  (let [[mf n] (clojure.string/split (:dictionary-form args) #", ")
        ...
        mf-forms (get-adjective-forms-mf (merge {:mf mf :df df :include-comparative? include-comparative? :include-superlative? include-superlative? :comp-gloss comp-gloss :sup-gloss sup-gloss} args))
        n-forms (get-adjective-forms-n (merge {:n n :df df :include-comparative? include-comparative? :include-superlative? include-superlative? :comp-gloss comp-gloss :sup-gloss sup-gloss} args))]
    (concat
     mf-forms
     n-forms)
    ))
