...
(defn get-verb-forms-ere [first-person-present infinitive first-person-perfect supine first-person-present-sg-gloss third-person-present-sg-gloss first-person-perfect-sg-gloss perfect-participle present-participle]
...
(defn get-verb-forms-ere* [{:keys [first-person-present infinitive first-person-perfect supine first-person-present-sg-gloss third-person-present-sg-gloss first-person-perfect-sg-gloss perfect-participle present-participle]}]
  (let [present-stem (subs first-person-present 0 (dec (count first-person-present)))
        perfect-stem (subs first-person-perfect 0 (dec (count first-person-perfect)))
        perfect-stem-minus-v (subs perfect-stem 0 (dec (count perfect-stem))) ;; for -ve syncopation
        infinitive-stem (subs infinitive 0 (dec (count infinitive)))
        df (clojure.string/join ", " [first-person-present infinitive first-person-perfect supine])
        participial-stem (subs supine 0 (- (count supine) 2))
        args (assoc :present-stem present-stem
