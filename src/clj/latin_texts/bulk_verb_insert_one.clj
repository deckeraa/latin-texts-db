...
(defn perfect-passive-participles-m [{:keys [participial-stem df present-participle perfect-participle dep?]}]
  (let [gloss (if dep?
...
(defn perfect-passive-participles-f [{:keys [participial-stem df present-participle perfect-participle dep?]}]
  (let [gloss (if dep?
                (str "was " present-participle)
                (str "having been " perfect-participle))]
...
(defn perfect-passive-participles-n [{:keys [participial-stem df present-participle perfect-participle dep?]}]
  (let [gloss (if dep?
                (str "was " present-participle)
                (str "having been " perfect-participle))]
